...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        match tuple {
            (0..256, 0..256, 0..256) => Ok(Self{red: tuple.0 as u8, green: tuple.1 as u8, blue: tuple.2 as u8}),
...
impl TryFrom<[i16; 3]> for Color {
    ...
    fn try_from(arr: [i16; 3]) -> Result<Self, Self::Error> {
        match arr {
            [0..256, 0..256, 0..256] => Ok(Self{red: arr[0] as u8, green: arr[1] as u8, blue: arr[2] as u8}),
            _ => Err(Self::Error::IntConversion)
        }
    }
}
...
impl TryFrom<&[i16]> for Color {
    ...
    fn try_from(slice: &[i16]) -> Result<Self, Self::Error> {
        match slice {
            [0..256, 0..256, 0..256] => Ok(Self{red: slice[0] as u8, green: slice[1] as u8, blue: slice[2] as u8}),
            s if s.len() != 3 => Err(Self::Error::BadLen),
            _ => Err(Self::Error::IntConversion)
        }
    }
}
